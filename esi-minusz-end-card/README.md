...
The ESI -Z End Card fits in the very "bottom" slot (Slot #3?) in the OreSat 3U backaplane. It's special because it hosts whatever antenna is on the -Z face of the satellite, which in this case is the ESI POD antenna. The -Z End Card:
...
- SMPM connectors (CM3) should be hand-added (there is no solder paste for their footprints).
- Dipole antenna must be hand added according to the Helical Antenna SOP.
- Resistor R1 must be hand added according to the OreSat End Card Deployment Resistor Mounting SOP.
- Press fit nuts HW1 - HW4 may be *carefully* added after SMT assembly is completed.
